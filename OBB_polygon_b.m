function [flag] = OBB_polygon_b(vertices_A,vertices_B,num_A,num_B)
flag = false;
vertices_A(end,:) = [];
vertices_B(end,:) = [];
...
%             end
        ...
        [rec_ss1,rec_1ssplot] = build_OBB(v_A);
        [rec_ss2,rec_2ssplot] = build_OBB(v_B);
        [rec_ss3,rec_3ssplot] = build_OBB(v_C);
        [rec_ss4,rec_4ssplot] = build_OBB(v_D);
        
        if OBB_collision(rec_ss1,rec_ss3)
            i_iter = i_iter + 1;
            v_1 = v_A;
            v_2 = v_C;
            v_3{i_iter} = v_B;
            ...
            rec_2 = rec_3ssplot;
            flag = true;
        elseif OBB_collision(rec_ss1,rec_ss4)
            i_iter = i_iter + 1;
            v_1 = v_A;
            v_2 = v_D;
            v_3{i_iter} = v_B;
            ...
            rec_2 = rec_4ssplot;
            flag = true;
        elseif OBB_collision(rec_ss2,rec_ss3)
            i_iter = i_iter + 1;
            v_1 = v_B;
            v_2 = v_C;
            v_3{i_iter} = v_A;
            ...
            rec_2 = rec_3ssplot;
            flag = true;
        elseif OBB_collision(rec_ss2,rec_ss4)
            i_iter = i_iter + 1;
            v_1 = v_B;
            v_2 = v_D;
            v_3{i_iter} = v_A;
